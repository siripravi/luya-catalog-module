...
use siripravi\catalog\models\Variant;
use siripravi\catalog\models\Buyer;
use siripravi\catalog\models\OrderProduct;
...
class Order extends ActiveRecord
{
    ...
    {
        return $this->hasMany(Article::class, ['id' => 'variant_id'])->viaTable('nxt_order_product', ['order_id' => 'id']);
    }

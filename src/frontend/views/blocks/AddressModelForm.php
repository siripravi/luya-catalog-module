    ...
    <?php if ($this->extraValue('isPreview')) : ?>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <?= StringHelper::template($this->varValue('previewButtonsTemplate', $this->context->previewButtonsTemplate), [
                ...
                'submit' => Html::a('Confirm & Submit', Yii::$app->request->referrer . '?submit=' . $this->varValue('formId'), ['id'=>'btn-buy','data-formid'=>$this->varValue('formId'),'data-key' =>'id','class' => 'btn btn-success btn-buy']),
